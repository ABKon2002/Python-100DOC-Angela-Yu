...
# Component 1 - The entry field [r = 0, c = 1]
miles_entry = Entry(width = 12)
miles_entry.grid(row = 0, column = 1)

# Component 2 - The label to the right of the entry field (miles) [r = 0, c = 2]
miles_label = Label(text = "miles")
miles_label.grid(row = 0, column = 2)


# Component 3 - The label to the bottom left of the entry field (is equal to) [r = 1, c = 0]
equal_to_label = Label(text = "is equal to")
equal_to_label.grid(row = 1, column = 0)

# Component 4 - The output label in the bottom of the entry field (Km value) [r = 1, c = 1]
km_value_label = Label(text = "")
km_value_label.grid(row = 1, column = 1)

# Component 5 - The label to the right of the output label (Km) [r = 1, c = 2]
km_label = Label(text = "km")
km_label.grid(row = 1, column = 2)


# Component 6 - The calculate button [r = 2, c = 1]
def convert_to_km():
    """
